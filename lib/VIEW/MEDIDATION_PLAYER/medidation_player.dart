...
class MedidationPlayer extends StatefulWidget {
  const MedidationPlayer({super.key});

  @override
  State<MedidationPlayer> createState() => _MedidationPlayerState();
}

class _MedidationPlayerState extends State<MedidationPlayer> {
              ...
              children: [
                Center(child: headerContainer(text: 'Meditation Player', colors: AppColors.white)),
                    Padding(
                      ...
                      child: Center(child: VideoTextField(text: 'Morning Flow')),
                    ),
                SizedBox(height: 20),
                Padding(
